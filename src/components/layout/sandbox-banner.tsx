...
export function SandboxBanner() {
  ...
  return (
    <div className="w-full bg-amber-100 dark:bg-amber-950/40 border-b border-amber-300 dark:border-amber-800 px-6 py-2 flex items-center justify-between gap-4 text-sm text-amber-900 dark:text-amber-100">
