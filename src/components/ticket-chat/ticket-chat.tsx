      ...
      <main className="flex-1 flex overflow-hidden">
                        ...
                        <div key={msg.id} className="flex gap-3">
                          {msg.senderType === "system" && (msg.kind === "claimed" || msg.kind === "ended") ? (
                            <div className="flex items-center gap-3 w-full">
                              <div
                                className="w-6 h-6 rounded-[11px] flex items-center justify-center text-sm font-medium text-foreground shrink-0"
                              ...
                              <div className="flex-1">
                                <div className="flex items-center gap-2 mb-1">
                                  ...
                                  <span className="text-xs" style={{ color: 'rgba(0,0,0,0.5)', fontFamily: 'var(--font-geist-mono), ui-monospace, monospace', fontVariantNumeric: 'tabular-nums' }}>{msg.timestamp}</span>
                                </div>
        ...
        <div className="w-80 bg-white border-l border-border relative z-20 flex flex-col">
          <div className="flex-1 overflow-y-auto pl-5 pr-4 py-6">
            {/* People in Chat */}
            <div>
              <h3 className="text-[11px] uppercase tracking-[0.05em] mb-3" style={{ color: 'rgba(0,0,0,0.5)', fontWeight: 500 }}>People in this chat</h3>
            ...
            <div>
              <div className="flex items-center gap-2 mb-3">
                <h3 className="text-[11px] uppercase tracking-[0.05em]" style={{ color: 'rgba(0,0,0,0.5)', fontWeight: 500 }}>Other topics in this chat</h3>
            ...
            <div>
              <div className="flex items-center gap-2 mb-3">
                <h3 className="text-[11px] uppercase tracking-[0.05em]" style={{ color: 'rgba(0,0,0,0.5)', fontWeight: 500 }}>Type of help</h3>
                <Info className="w-4 h-4 text-muted-foreground" />
              </div>
              {helpTypes.length > 0 ? (
                <div className="flex flex-wrap gap-2">
