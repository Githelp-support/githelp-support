    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 p-6 overflow-y-auto">
          ...
          <div className="space-y-4 mb-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <Select value={currentView} onValueChange={(value) => handleViewChange(value as "added" | "requests" | "invited")}>
                <SelectTrigger className="w-full h-[46px] data-[size=default]:h-[46px] border-[#CFCFD8] shadow-none rounded-lg text-[14px] font-normal">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 h-[46px] border-[#CFCFD8] shadow-none rounded-lg text-[13px] placeholder:text-[#94a3b8] focus:border-brand-primary transition-colors"
                  value={searchQuery}
          ...
          {/* Table */}
          <div className="bg-white rounded-lg border border-[#CFCFD8] shadow-none overflow-hidden">
            {/* Table Header */}
