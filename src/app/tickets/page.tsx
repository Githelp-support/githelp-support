      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 p-6 space-y-6 overflow-y-auto">
          ...
          <div className="grid grid-cols-4 gap-4">
            ...
            >
              <Card className="relative overflow-hidden rounded-lg border-[#CFCFD8] py-0 shadow-none transition-colors hover:bg-muted/40">
                {statusFilter === "all" && (
          ...
          {/* Tickets Table */}
          <div className="bg-white rounded-lg border border-[#CFCFD8] overflow-hidden shadow-none">
                ...
                if (isUnclaimed(ticket)) {
                  ...
                  return (
                    ...
                    >
                      ...
                      {isExpanded && (
                        <div className="mt-4 pl-[50px] space-y-4">
                          {/* Full question asked */}
                          <div>
                          ...
                          {/* Access the full ticket in addition to the inline expansion */}
                          <div>
                            <Link
                              href={`/helper/tickets/${ticket.id}`}
                              onClick={(e) => e.stopPropagation()}
                            >
                              <Button variant="lavender">Open ticket</Button>
                            </Link>
                          </div>
                        </div>
                      )}
